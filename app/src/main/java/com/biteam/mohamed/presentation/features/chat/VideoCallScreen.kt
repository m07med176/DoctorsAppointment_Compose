...
data class VideoCallScreen(val model: MessageModel) : Screen {
    @Composable
    override fun Content() {
        val navigator = LocalNavigator.currentOrThrow
        VideoCallContent(model, navigator)
    }
}
...
@Composable
fun VideoCallContent(model: MessageModel, navigator: Navigator? = null) {
    Box(
        modifier = Modifier
            .fillMaxSize()
    ) {
