    ...
    override fun Content() {
        ...
        val actions = ChatCallBackActions(
            onMessageItemClicked = {
                navigator.parent?.push(ChatRoomScreen(it))
            },
            onActiveItemClicked = {
                navigator.parent?.push(ChatRoomScreen(it))
            }
...
data class ChatCallBackActions(
    ...
    val onActiveItemClicked: (MessageModel) -> Unit
)
...
@Composable
fun ActiveNowSection(onItemClicked: (MessageModel) -> Unit) {
    Column {
        Text(
            text = "Active Now",
            style = TextStyle(
...
@Composable
fun ActiveNowItem(model: MessageModel, onItemClicked: (MessageModel) -> Unit) {
